...
impl UndecadSystem {
    ...
    pub const COHERENCE: &'static str = "Articulate Symmetry";
    ...
    pub const COLOURS_HEX: [&'static str; 11] = ["#FF0000", "#0000FF", "#FFFF00", "#099902", "#9900FF", "#FFA500", "#00FFFF", "#8B4513", "#FF00FF", "#FFFFFF", "#C0C0C0"];
    pub const COLOURS_NAME: [&'static str; 11] = ["Red", "Blue", "Yellow", "Green", "Purple", "Orange", "Light Blue", "Brown", "Magenta", "White", "Silver"];
    pub const COORDS: [(f64, f64); 11] = [
        (0.0, 1.0),                        // Position 1 (top)
        (0.54064081745, 0.84125353283),    // Position 2
        (0.909632, 0.415415),              // Position 3
        (0.989821, -0.142315),             // Position 4
        (0.755750, -0.654861),             // Position 5
        (0.281733, -0.959493),             // Position 6
        (-0.281733, -0.959493),            // Position 7
        (-0.755750, -0.654861),            // Position 8
        (-0.989821, -0.142315),            // Position 9
        (-0.909632, 0.415415),             // Position 10
        (-0.54064081745, 0.84125353283),   // Position 11
    ];

    // Connectives - reference by position INDEX (complete graph: 55 edges)
